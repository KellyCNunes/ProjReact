...
function App() {
  return (
    <div className="app">
      <h1 className="app-title">Meu App com React</h1>
      <Gallery />
    </div>
  );
}
    ...
    return (
      <div>
        <div className="imagem-com-texto">
          <img src="path/to/https://guiadoestudante.abril.com.br/wp-content/uploads/sites/4/2020/07/dandara.jpg?quality=70&strip=info&w=650" alt="Valerie Thomas" className="imagem" />
